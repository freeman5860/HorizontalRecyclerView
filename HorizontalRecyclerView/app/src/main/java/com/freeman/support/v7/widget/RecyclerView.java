...
package com.freeman.support.v7.widget;
...
import com.freeman.support.v7.annotation.Nullable;
import android.support.v4.util.ArrayMap;
import com.freeman.support.v4.util.Pools;
import android.support.v4.view.MotionEventCompat;
import android.support.v4.view.VelocityTrackerCompat;
import android.support.v4.widget.EdgeEffectCompat;

import com.freeman.support.v4.view.ViewCompat;
import com.freeman.support.v4.widget.ScrollerCompat;
 ...
 *
 * <ul>
 *     <li><em>Adapter:</em> A subclass of {@link com.freeman.support.v7.widget.RecyclerView.Adapter} responsible for providing views
...
public class RecyclerView extends ViewGroup {
    ...
    ItemAnimator mItemAnimator = new com.freeman.support.v7.widget.DefaultItemAnimator();
     ...
     * @see #setAdapter(com.freeman.support.v7.widget.RecyclerView.Adapter)
     */
    ...
    /**
     * Set the {@link com.freeman.support.v7.widget.RecyclerView.LayoutManager} that this RecyclerView will use.
     *
     * <p>In contrast to other adapter-backed views such as {@link android.widget.ListView}
     * or {@link android.widget.GridView}, RecyclerView allows client code to provide custom
     * layout arrangements for child views. These arrangements are controlled by the
     * {@link com.freeman.support.v7.widget.RecyclerView.LayoutManager}. A LayoutManager must be provided for RecyclerView to function.</p>
     *
    ...
    /**
     * Return the {@link com.freeman.support.v7.widget.RecyclerView.LayoutManager} currently responsible for
    ...
    /**
     * Retrieve this RecyclerView's {@link com.freeman.support.v7.widget.RecyclerView.RecycledViewPool}. This method will never return null;
     * if no pool is set for this view a new one will be created. See
     * {@link #setRecycledViewPool(com.freeman.support.v7.widget.RecyclerView.RecycledViewPool) setRecycledViewPool} for more information.
     *
     * @return The pool used to store recycled item views for reuse.
     * @see #setRecycledViewPool(com.freeman.support.v7.widget.RecyclerView.RecycledViewPool)
     */
    ...
    /**
     * Add an {@link com.freeman.support.v7.widget.RecyclerView.ItemDecoration} to this RecyclerView. Item decorations can
    ...
    /**
     * Remove an {@link com.freeman.support.v7.widget.RecyclerView.ItemDecoration} from this RecyclerView.
     *
     * <p>The given decoration will no longer impact the measurement and drawing of
     * item views.</p>
     *
     * @param decor Decoration to remove
     * @see #addItemDecoration(com.freeman.support.v7.widget.RecyclerView.ItemDecoration)
     */
     ...
     * {@link com.freeman.support.v7.widget.RecyclerView.LayoutManager#scrollToPosition(int)}
     * @param position Scroll to this adapter position
     * @see com.freeman.support.v7.widget.RecyclerView.LayoutManager#scrollToPosition(int)
     */
     ...
     * {@link com.freeman.support.v7.widget.RecyclerView.LayoutManager#smoothScrollToPosition(com.freeman.support.v7.widget.RecyclerView, com.freeman.support.v7.widget.RecyclerView.State, int)} and create a
     * {@link com.freeman.support.v7.widget.RecyclerView.SmoothScroller}.
     * <p>
     * {@link com.freeman.support.v7.widget.RecyclerView.LayoutManager} is responsible for creating the actual scroll action. If you want to
     * provide a custom smooth scroll logic, override
     * {@link com.freeman.support.v7.widget.RecyclerView.LayoutManager#smoothScrollToPosition(com.freeman.support.v7.widget.RecyclerView, com.freeman.support.v7.widget.RecyclerView.State, int)} in your
     * LayoutManager.
     *
     * @param position The adapter position to scroll to
     * @see com.freeman.support.v7.widget.RecyclerView.LayoutManager#smoothScrollToPosition(com.freeman.support.v7.widget.RecyclerView, com.freeman.support.v7.widget.RecyclerView.State, int)
     */
    ...
    void scrollByInternal(int x, int y) {
        ...
        if (mScrollListener != null && (x != 0 || y != 0)) {
            mScrollListener.onScrolled(this, x, y);
        }
        if (mScrollListeners != null && (x != 0 || y != 0)) {
            for (int i = mScrollListeners.size() - 1; i >= 0; i--) {
                mScrollListeners.get(i).onScrolled(this, x, y);
            }
        }
        if (!awakenScrollBars()) {
            invalidate();
     ...
     * {@link com.freeman.support.v7.widget.RecyclerView.LayoutManager#computeHorizontalScrollOffset(com.freeman.support.v7.widget.RecyclerView.State)} in your
     * LayoutManager. </p>
     *
     * @return The horizontal offset of the scrollbar's thumb
     * @see com.freeman.support.v7.widget.RecyclerView.LayoutManager#computeHorizontalScrollOffset
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link com.freeman.support.v7.widget.RecyclerView.LayoutManager#computeHorizontalScrollExtent(com.freeman.support.v7.widget.RecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The horizontal extent of the scrollbar's thumb
     * @see com.freeman.support.v7.widget.RecyclerView.LayoutManager#computeHorizontalScrollExtent(com.freeman.support.v7.widget.RecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link com.freeman.support.v7.widget.RecyclerView.LayoutManager#computeHorizontalScrollRange(com.freeman.support.v7.widget.RecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The total horizontal range represented by the vertical scrollbar
     * @see com.freeman.support.v7.widget.RecyclerView.LayoutManager#computeHorizontalScrollRange(com.freeman.support.v7.widget.RecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link com.freeman.support.v7.widget.RecyclerView.LayoutManager#computeVerticalScrollOffset(com.freeman.support.v7.widget.RecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The vertical offset of the scrollbar's thumb
     * @see com.freeman.support.v7.widget.RecyclerView.LayoutManager#computeVerticalScrollOffset
     * (RecyclerView.Adapter)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link com.freeman.support.v7.widget.RecyclerView.LayoutManager#computeVerticalScrollExtent(com.freeman.support.v7.widget.RecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The vertical extent of the scrollbar's thumb
     * @see com.freeman.support.v7.widget.RecyclerView.LayoutManager#computeVerticalScrollExtent(com.freeman.support.v7.widget.RecyclerView.State)
     */
    @Override
     ...
     *
     * <p>If you want to support scroll bars, override
     * {@link com.freeman.support.v7.widget.RecyclerView.LayoutManager#computeVerticalScrollRange(com.freeman.support.v7.widget.RecyclerView.State)} in your
     * LayoutManager.</p>
     *
     * @return The total vertical range represented by the vertical scrollbar
     * @see com.freeman.support.v7.widget.RecyclerView.LayoutManager#computeVerticalScrollRange(com.freeman.support.v7.widget.RecyclerView.State)
     */
    @Override
    ...
    /**
     * Add an {@link com.freeman.support.v7.widget.RecyclerView.OnItemTouchListener} to intercept touch events before they are dispatched
     * to child views or this view's standard scrolling behavior.
     *
     * <p>Client code may use listeners to implement item manipulation behavior. Once a listener
     * returns true from
     * {@link com.freeman.support.v7.widget.RecyclerView.OnItemTouchListener#onInterceptTouchEvent(com.freeman.support.v7.widget.RecyclerView, MotionEvent)} its
     * {@link com.freeman.support.v7.widget.RecyclerView.OnItemTouchListener#onTouchEvent(com.freeman.support.v7.widget.RecyclerView, MotionEvent)} method will be called
    ...
    /**
     * Remove an {@link com.freeman.support.v7.widget.RecyclerView.OnItemTouchListener}. It will no longer be able to intercept touch events.
     *
    ...
    /**
     * Sets the {@link com.freeman.support.v7.widget.RecyclerView.ItemAnimator} that will handle animations involving changes
     * to the items in this RecyclerView. By default, RecyclerView instantiates and
     * uses an instance of {@link com.freeman.support.v7.widget.DefaultItemAnimator}. Whether item animations are
     * enabled for the RecyclerView depends on the ItemAnimator and whether
     * the LayoutManager {@link com.freeman.support.v7.widget.RecyclerView.LayoutManager#supportsPredictiveItemAnimations()
     ...
     * uses an instance of {@link com.freeman.support.v7.widget.DefaultItemAnimator}.
     *
     ...
     * PERSISTENT views are moved ({@link com.freeman.support.v7.widget.RecyclerView.ItemAnimator#animateMove(com.freeman.support.v7.widget.RecyclerView.ViewHolder, int, int, int, int)})
     * REMOVED views are removed ({@link com.freeman.support.v7.widget.RecyclerView.ItemAnimator#animateRemove(com.freeman.support.v7.widget.RecyclerView.ViewHolder)})
     * ADDED views are added ({@link com.freeman.support.v7.widget.RecyclerView.ItemAnimator#animateAdd(com.freeman.support.v7.widget.RecyclerView.ViewHolder)})
    ...
    /**
     * Retrieve the {@link com.freeman.support.v7.widget.RecyclerView.ViewHolder} for the given child view.
     *
     ...
     * use an Adapter with {@link com.freeman.support.v7.widget.RecyclerView.Adapter#setHasStableIds(boolean) stableIds} to
     ...
     * Useful for implementing simple scrolling in {@link com.freeman.support.v7.widget.RecyclerView.LayoutManager LayoutManagers}.
     *
     ...
     * {@link com.freeman.support.v7.widget.RecyclerView.LayoutManager} measures or lays out the view and is a good time to perform these
     * changes.</p>
     *
     ...
     * {@link com.freeman.support.v7.widget.RecyclerView.LayoutManager} fully detaches the child view from the parent and its window.</p>
     *
    ...
    private class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if (mScrollListener != null && (x != 0 || y != 0)) {
                    mScrollListener.onScrolled(RecyclerView.this, dx, dy);
                }
                if (mScrollListeners != null && (x != 0 || y != 0)) {
                    for (int i = mScrollListeners.size() - 1; i >= 0; i--) {
                        mScrollListeners.get(i).onScrolled(RecyclerView.this, dx, dy);
                    }
                }
     ...
     *
     * <p>Typical use of a Recycler by a {@link com.freeman.support.v7.widget.RecyclerView.LayoutManager} will be to obtain views for
    ...
    public final class Recycler {
         ...
         *
         * <p>This method should be used by {@link com.freeman.support.v7.widget.RecyclerView.LayoutManager} implementations to obtain
         * views to represent data from an {@link com.freeman.support.v7.widget.RecyclerView.Adapter}.</p>
         *
     ...
     * within a {@link com.freeman.support.v7.widget.RecyclerView}.</p>
     */
    public static abstract class Adapter<VH extends ViewHolder> {
         ...
         *
         * <p>A view is recycled when a {@link com.freeman.support.v7.widget.RecyclerView.LayoutManager} decides that it no longer
         * needs to be attached to its parent {@link com.freeman.support.v7.widget.RecyclerView}. This can be because it has
         ...
         * {@link #onViewDetachedFromWindow(com.freeman.support.v7.widget.RecyclerView.ViewHolder) onViewDetachedFromWindow}
         ...
         * {@link com.freeman.support.v7.widget.RecyclerView.AdapterDataObserver#onChanged()
         * "something changed"} event if more specific data is not available.</p>
         *
         * <p>Components registering observers with an adapter are responsible for
         * {@link #unregisterAdapterDataObserver(com.freeman.support.v7.widget.RecyclerView.AdapterDataObserver)
         * unregistering} those observers when finished.</p>
         *
         * @param observer Observer to register
         *
         * @see #unregisterAdapterDataObserver(com.freeman.support.v7.widget.RecyclerView.AdapterDataObserver)
         */
         ...
         *
         * @see #registerAdapterDataObserver(com.freeman.support.v7.widget.RecyclerView.AdapterDataObserver)
         */
    ...
    public static abstract class LayoutManager {
         ...
         * rules as outlined in {@link #onLayoutChildren(com.freeman.support.v7.widget.RecyclerView.Recycler, com.freeman.support.v7.widget.RecyclerView.State)}.
         ...
         * {@link com.freeman.support.v7.widget.RecyclerView#setItemAnimator(com.freeman.support.v7.widget.RecyclerView.ItemAnimator) ItemAnimator} set on the
         ...
         * then there will be two calls to {@link #onLayoutChildren(com.freeman.support.v7.widget.RecyclerView.Recycler, com.freeman.support.v7.widget.RecyclerView.State)} to
        ...
        public boolean getClipToPadding() {
            //TODO return mRecyclerView != null && mRecyclerView.mClipToPadding;
            return false;
        }
         ...
         * normal layout operation during {@link #onLayoutChildren(com.freeman.support.v7.widget.RecyclerView.Recycler, com.freeman.support.v7.widget.RecyclerView.State)}, the
         * RecyclerView will have enough information to run those animations in a simple
         * way. For example, the default ItemAnimator, {@link com.freeman.support.v7.widget.DefaultItemAnimator}, will
         ...
         * {@link #onLayoutChildren(com.freeman.support.v7.widget.RecyclerView.Recycler, com.freeman.support.v7.widget.RecyclerView.State)}. Supporting predictive animations
         * means that {@link #onLayoutChildren(com.freeman.support.v7.widget.RecyclerView.Recycler, com.freeman.support.v7.widget.RecyclerView.State)} will be called twice;
         ...
         * appropriately. Also, {@link com.freeman.support.v7.widget.RecyclerView.LayoutParams#isItemRemoved() removed} items will
         ...
         * {@link com.freeman.support.v7.widget.RecyclerView.LayoutParams} for this purpose.</p>
         *
         * <p><em>Important:</em> if you use your own custom <code>LayoutParams</code> type
         * you must also override
         * {@link #checkLayoutParams(com.freeman.support.v7.widget.RecyclerView.LayoutParams)},
         ...
         * <p>To support smooth scrolling, override this method, create your {@link com.freeman.support.v7.widget.RecyclerView.SmoothScroller}
         * instance and call {@link #startSmoothScroll(com.freeman.support.v7.widget.RecyclerView.SmoothScroller)}.
         * </p>
         ...
         * use this method to add views obtained from a {@link com.freeman.support.v7.widget.RecyclerView.Recycler} using
         * {@link com.freeman.support.v7.widget.RecyclerView.Recycler#getViewForPosition(int)}.
         *
         ...
         * {@link com.freeman.support.v7.widget.RecyclerView.Recycler#recycleView(View)}.
         *
         ...
         * will want to use {@link #detachAndScrapView(View, com.freeman.support.v7.widget.RecyclerView.Recycler)}
         ...
         * {@link #attachView(View, int, com.freeman.support.v7.widget.RecyclerView.LayoutParams) reattach}
         ...
         * {@link #detachAndScrapView(View, com.freeman.support.v7.widget.RecyclerView.Recycler)}  scrapped}.
         *
        ...
        /**
         * Detach a child view and add it to a {@link com.freeman.support.v7.widget.RecyclerView.Recycler Recycler's} scrap heap.
         *
         ...
         * any insets applied by {@link com.freeman.support.v7.widget.RecyclerView.ItemDecoration ItemDecorations}.
         *
         * @param child Child view to query
         ...
         * include any current {@link com.freeman.support.v7.widget.RecyclerView.ItemDecoration ItemDecorations}.
         *
         ...
         * {@link com.freeman.support.v7.widget.RecyclerView.ItemDecoration ItemDecorations}.
         *
         ...
         * then {@link #onFocusSearchFailed(View, int, com.freeman.support.v7.widget.RecyclerView.Recycler, com.freeman.support.v7.widget.RecyclerView.State)}
         ...
         *                   {@link #setAdapter(com.freeman.support.v7.widget.RecyclerView.Adapter)} is called with {@code null}.
         */
         ...
         *
         * <p>Read {@link com.freeman.support.v7.widget.RecyclerView#computeHorizontalScrollExtent()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current state of RecyclerView
         * @return The horizontal extent of the scrollbar's thumb
         * @see com.freeman.support.v7.widget.RecyclerView#computeHorizontalScrollExtent()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link com.freeman.support.v7.widget.RecyclerView#computeHorizontalScrollOffset()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The horizontal offset of the scrollbar's thumb
         * @see com.freeman.support.v7.widget.RecyclerView#computeHorizontalScrollOffset()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link com.freeman.support.v7.widget.RecyclerView#computeHorizontalScrollRange()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The total horizontal range represented by the vertical scrollbar
         * @see com.freeman.support.v7.widget.RecyclerView#computeHorizontalScrollRange()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link com.freeman.support.v7.widget.RecyclerView#computeVerticalScrollExtent()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current state of RecyclerView
         * @return The vertical extent of the scrollbar's thumb
         * @see com.freeman.support.v7.widget.RecyclerView#computeVerticalScrollExtent()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link com.freeman.support.v7.widget.RecyclerView#computeVerticalScrollOffset()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The vertical offset of the scrollbar's thumb
         * @see com.freeman.support.v7.widget.RecyclerView#computeVerticalScrollOffset()
         */
         ...
         * <p>Override this method if you want to support scroll bars.</p>
         *
         * <p>Read {@link com.freeman.support.v7.widget.RecyclerView#computeVerticalScrollRange()} for details.</p>
         *
         * <p>Default implementation returns 0.</p>
         *
         * @param state Current State of RecyclerView where you can find total item count
         * @return The total vertical range represented by the vertical scrollbar
         * @see com.freeman.support.v7.widget.RecyclerView#computeVerticalScrollRange()
         */
     ...
     * views (in {@link com.freeman.support.v7.widget.RecyclerView.ItemDecoration#onDraw(Canvas, com.freeman.support.v7.widget.RecyclerView) onDraw()} and after the items
     * (in {@link com.freeman.support.v7.widget.RecyclerView.ItemDecoration#onDrawOver(Canvas, com.freeman.support.v7.widget.RecyclerView)}.</p>
     */
     ...
     *
     * @see com.freeman.support.v7.widget.RecyclerView#setOnScrollListener(com.freeman.support.v7.widget.RecyclerView.OnScrollListener)
     */
...
//    }
     ...
     * a view is recycled.
     *
     * @see com.freeman.support.v7.widget.RecyclerView#setRecyclerListener(com.freeman.support.v7.widget.RecyclerView.RecyclerListener)
     */
     ...
     *
     * <p>{@link com.freeman.support.v7.widget.RecyclerView.Adapter} implementations should subclass ViewHolder and add fields for caching
     * potentially expensive {@link View#findViewById(int)} results.</p>
     *
     * <p>While {@link com.freeman.support.v7.widget.RecyclerView.LayoutParams} belong to the {@link com.freeman.support.v7.widget.RecyclerView.LayoutManager},
     * {@link com.freeman.support.v7.widget.RecyclerView.ViewHolder ViewHolders} belong to the adapter. Adapters should feel free to use
     ...
     * {@link com.freeman.support.v7.widget.RecyclerView}. Custom {@link com.freeman.support.v7.widget.RecyclerView.LayoutManager layout managers} are encouraged
    ...
    /**
     * Observer base class for watching changes to an {@link com.freeman.support.v7.widget.RecyclerView.Adapter}.
     * See {@link com.freeman.support.v7.widget.RecyclerView.Adapter#registerAdapterDataObserver(com.freeman.support.v7.widget.RecyclerView.AdapterDataObserver)}.
     */
     ...
     *
     * @see com.freeman.support.v7.widget.LinearSmoothScroller
     */
    public static abstract class SmoothScroller {
         ...
         * <p>In each animation step, {@link com.freeman.support.v7.widget.RecyclerView} will check
         * for the target view and call either
         * {@link #onTargetFound(View, com.freeman.support.v7.widget.RecyclerView.State, com.freeman.support.v7.widget.RecyclerView.SmoothScroller.Action)} or
         * {@link #onSeekTargetStep(int, int, com.freeman.support.v7.widget.RecyclerView.State, com.freeman.support.v7.widget.RecyclerView.SmoothScroller.Action)} until
         ...
         * cancel any existing {@link com.freeman.support.v7.widget.RecyclerView.SmoothScroller.Action} updated by
         * {@link #onTargetFound(View, com.freeman.support.v7.widget.RecyclerView.State, com.freeman.support.v7.widget.RecyclerView.SmoothScroller.Action)} or
         * {@link #onSeekTargetStep(int, int, com.freeman.support.v7.widget.RecyclerView.State, com.freeman.support.v7.widget.RecyclerView.SmoothScroller.Action)}.
         */
         ...
         * {@link com.freeman.support.v7.widget.RecyclerView#NO_POSITION} if no target view is set.
         */
        ...
        /**
         * @see com.freeman.support.v7.widget.RecyclerView#getChildPosition(View)
         */
        ...
        /**
         * @see com.freeman.support.v7.widget.RecyclerView#getChildCount()
         */
        public int getChildCount() {
        ...
        /**
         * @see com.freeman.support.v7.widget.RecyclerView.LayoutManager#findViewByPosition(int)
         */
        public View findViewByPosition(int position) {
        ...
        /**
         * @see com.freeman.support.v7.widget.RecyclerView#scrollToPosition(int)
         */
         ...
         * provided {@link com.freeman.support.v7.widget.RecyclerView.SmoothScroller.Action} to define the next scroll.</p>
         *
         ...
         * will receive and it should update the provided {@link com.freeman.support.v7.widget.RecyclerView.SmoothScroller.Action} to define the scroll
         * details towards the target view.
         * @param targetView    The view element which render the target position.
         * @param state         Transient state of RecyclerView
         * @param action        Action instance that you should update to define final scroll action
         *                      towards the targetView
         * @return An {@link com.freeman.support.v7.widget.RecyclerView.SmoothScroller.Action} to finalize the smooth scrolling
         */
        abstract protected void onTargetFound(View targetView, State state, Action action);

        /**
         * Holds information about a smooth scroll request by a {@link com.freeman.support.v7.widget.RecyclerView.SmoothScroller}.
         */
    ...
    public static class State {
         ...
         * {@link com.freeman.support.v7.widget.RecyclerView#NO_POSITION} if there is no target
         * position.
         */
     ...
     * method when each item animation is done ({@link #dispatchRemoveFinished(com.freeman.support.v7.widget.RecyclerView.ViewHolder)},
     * {@link #dispatchMoveFinished(com.freeman.support.v7.widget.RecyclerView.ViewHolder)}, or {@link #dispatchAddFinished(com.freeman.support.v7.widget.RecyclerView.ViewHolder)}).
     *
     * <p>By default, RecyclerView uses {@link com.freeman.support.v7.widget.DefaultItemAnimator}</p>
     *
     * @see #setItemAnimator(com.freeman.support.v7.widget.RecyclerView.ItemAnimator)
     */
    public static abstract class ItemAnimator {
         ...
         * is governed by the return values from {@link #animateAdd(com.freeman.support.v7.widget.RecyclerView.ViewHolder) animateAdd()},
         * {@link #animateMove(com.freeman.support.v7.widget.RecyclerView.ViewHolder, int, int, int, int) animateMove()}, and
         * {@link #animateRemove(com.freeman.support.v7.widget.RecyclerView.ViewHolder) animateRemove()}, which inform the
         ...
         * {@link #dispatchRemoveFinished(com.freeman.support.v7.widget.RecyclerView.ViewHolder)} when done, either
         * immediately (if no animation will occur) or after the animation actually finishes.
         * The return value indicates whether an animation has been set up and whether the
         * ItemAnimators {@link #runPendingAnimations()} method should be called at the
         * next opportunity. This mechanism allows ItemAnimator to set up individual animations
         * as separate calls to {@link #animateAdd(com.freeman.support.v7.widget.RecyclerView.ViewHolder) animateAdd()},
         * {@link #animateMove(com.freeman.support.v7.widget.RecyclerView.ViewHolder, int, int, int, int) animateMove()}, and
         * {@link #animateRemove(com.freeman.support.v7.widget.RecyclerView.ViewHolder) animateRemove()} come in one by one, then
         ...
         * whether and how to animate that change, but must always call
         * {@link #dispatchAddFinished(com.freeman.support.v7.widget.RecyclerView.ViewHolder)} when done, either
         * immediately (if no animation will occur) or after the animation actually finishes.
         * The return value indicates whether an animation has been set up and whether the
         * ItemAnimators {@link #runPendingAnimations()} method should be called at the
         * next opportunity. This mechanism allows ItemAnimator to set up individual animations
         ...
         * whether and how to animate that change, but must always call
         * {@link #dispatchMoveFinished(com.freeman.support.v7.widget.RecyclerView.ViewHolder)} when done, either
         * immediately (if no animation will occur) or after the animation actually finishes.
         * The return value indicates whether an animation has been set up and whether the
         * ItemAnimators {@link #runPendingAnimations()} method should be called at the
         * next opportunity. This mechanism allows ItemAnimator to set up individual animations
         ...
         * Also, appropriate dispatch methods (e.g., {@link #dispatchAddFinished(com.freeman.support.v7.widget.RecyclerView.ViewHolder)}
         ...
         *
         * @see #isRunning(com.freeman.support.v7.widget.RecyclerView.ItemAnimator.ItemAnimatorFinishedListener)
         */
